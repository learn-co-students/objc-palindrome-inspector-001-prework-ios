...
- (NSString *)stringByReversingString:(NSString *)string {
    ...
    bool neverOddIsAPalindrome = [self stringIsPalindrome:neverOdd];
    NSLog(@"%d : %@", neverOddIsAPalindrome, neverOdd);
    ...
    NSString *papayaWar = @" No Sir! Away! A papaya was is on.";
