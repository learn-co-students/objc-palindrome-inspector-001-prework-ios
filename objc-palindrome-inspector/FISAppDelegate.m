...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    BOOL thisIsNotAPalindrome = [self stringIsPalindrome:notAPalindrome];
    NSLog(@"%d: %@", thisIsNotAPalindrome, notAPalindrome);
...
- (BOOL)stringIsPalindrome:(NSString *)string {
    ...
    NSString *spaceless = [withoutPunctuation stringByReplacingOccurrencesOfString:@" "
                                                            withString:@""];
