...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    BOOL racecarIsPalendrome = [self stringIsPalindrome:racecar];
    NSLog(@"%d:%@", racecarIsPalendrome, racecar);
    
    BOOL palindromeIsPalindrome = [self stringIsPalindrome:palindrome];
    NSLog(@"%d:%@", palindromeIsPalindrome, palindrome);
    
    NSString *bob = @"Bob";
    BOOL bobIsPalendrome = [self stringIsPalindrome:bob];
    NSLog(@"%d:%@", bobIsPalendrome, bob);
    ...
    BOOL aibohphobiaIsPalendrome = [self stringIsPalindrome:aibohphobia];
    NSLog(@"%d:%@", aibohphobiaIsPalendrome, aibohphobia);
